...
class FunShekel07(TestFunction):
    def evaluate(self, X, grad=False):
        """
        Shekel 7 function
        1 global minimum: f(4,4,4,4)=-10.40282
        Design space: 0<xi<10
        """
        a = np.array([[4,4,4,4],[1,1,1,1],[8,8,8,8],[6,6,6,6],
                      [3,7,3,7],[2,9,2,9],[5,5,3,3]], dtype=float)
        c = 0.1 * np.array([1, 2, 2, 4, 4, 6, 3], dtype=float)
        m = 7
        dim = 4
